...
function Hero() {
    return (
        <section id="home" className="relative w-full min-h-[calc(100vh-80px)] flex items-center px-6 md:px-12 lg:px-20 xl:px-24">
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-[1440px] flex-col items-center justify-center gap-12 lg:flex-row lg:items-center lg:justify-between lg:gap-32 xl:gap-40">
                <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, ease: 'easeOut' }} className="flex-1 w-full max-w-[720px] space-y-6 text-center lg:text-left">
                ...
                <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, ease: 'easeOut' }} className="relative flex w-full items-center justify-center lg:w-auto">
                    ...
                    <div className="relative flex h-[260px] w-[260px] sm:h-[320px] sm:w-[320px] md:h-[420px] md:w-[420px] lg:h-[460px] lg:w-[460px] items-center justify-center rounded-full border border-white/10 bg-slate-950/70 shadow-soft">
