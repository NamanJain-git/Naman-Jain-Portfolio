...
function About() {
  return (
    <section id="about" className="relative w-full py-24 px-6 md:px-12 lg:px-20 xl:px-24">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.75, ease: 'easeOut', delay: 0.15 }} className="mt-14 rounded-[28px] border border-white/10 bg-slate-950/70 p-10 shadow-soft sm:p-14">
